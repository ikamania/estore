...
const Product = ({ id, image, price, text }) => {
  return (
    <div className="min-w-[15rem] w-[100%] sm:w-[30%] h-[20rem] p-[.5rem] mb-2 cursor-pointer bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
      <Link to={`/product/${id}`}>
